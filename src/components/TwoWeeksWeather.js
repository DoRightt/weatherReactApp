...
export class TwoWeeksWeather extends Component {
    constructor(props) {
        super(props);
        this.state = {
            temperature: '',
        ...
        return (
            <div className="current-week__block cweek-block cweek-block--ten">
                <div className="cweek-block__weather">
                    ...
                    <div className="current-week__item">
                        <div className="cweek-item__date">
                            <span className="cdate__day-of-week" style={daysOfWeek[10] === 'Сб' || daysOfWeek[10] === 'Вс' ? {color: '#e25555'} : {}}>{daysOfWeek[10]}</span>
                            <span className="cdate__day-of-month">{day[10]} {this.state.months[month[10]]}</span>
                        </div>
                        <div className="cweek-item__icon">
                            <img src={this.state.iconSet[this.state.iconsURL[10]]} alt=""/>
                        </div>
                        <div className="cweek-item__temp">
                            <div className="temp__day">{temp[10][1]}&#176;</div>
                            <div className="temp__night">{temp[10][0]}&#176;</div>
                        </div>
                        <div className="current-day__separator">
                            <div className="sep-line"></div>
                        </div>
                        <div className="thday-block__wind">
                            <div className="thday__item">
                                <div className="thday-item__wind">{wind[10]}</div>
                            </div>
                        </div>
                        <div className="current-day__separator">
                            <div className="sep-line"></div>
                        ...
                        <div className="thday-block__precip">
                            <div className="thday__item">
                                <div className="thday-item__precip">{precip[10]}</div>
                            </div>
                        </div>
                    </div>
                    <div className="current-week__item">
                        <div className="cweek-item__date">
                            <span className="cdate__day-of-week" style={daysOfWeek[11] === 'Сб' || daysOfWeek[11] === 'Вс' ? {color: '#e25555'} : {}}>{daysOfWeek[11]}</span>
                            <span className="cdate__day-of-month">{day[11]} {this.state.months[month[11]]}</span>
                        </div>
                        <div className="cweek-item__icon">
                            <img src={this.state.iconSet[this.state.iconsURL[11]]} alt=""/>
                        </div>
                        <div className="cweek-item__temp">
                            <div className="temp__day">{temp[11][1]}&#176;</div>
                            <div className="temp__night">{temp[11][0]}&#176;</div>
                        </div>
                        <div className="current-day__separator">
                            <div className="sep-line"></div>
                        </div>
                        <div className="thday-block__wind">
                            <div className="thday__item">
                                <div className="thday-item__wind">{wind[11]}</div>
                            </div>
                        </div>
                        <div className="current-day__separator">
                            <div className="sep-line"></div>
                        ...
                        <div className="thday-block__precip">
                            <div className="thday__item">
                                <div className="thday-item__precip">{precip[11]}</div>
                            </div>
                        </div>
                    </div>
                    <div className="current-week__item">
                        <div className="cweek-item__date">
                            <span className="cdate__day-of-week" style={daysOfWeek[12] === 'Сб' || daysOfWeek[12] === 'Вс' ? {color: '#e25555'} : {}}>{daysOfWeek[12]}</span>
                            <span className="cdate__day-of-month">{day[12]} {this.state.months[month[12]]}</span>
                        </div>
                        <div className="cweek-item__icon">
                            <img src={this.state.iconSet[this.state.iconsURL[12]]} alt=""/>
                        </div>
                        <div className="cweek-item__temp">
                            <div className="temp__day">{temp[12][1]}&#176;</div>
                            <div className="temp__night">{temp[12][0]}&#176;</div>
                        </div>
                        <div className="current-day__separator">
                            <div className="sep-line"></div>
                        </div>
                        <div className="thday-block__wind">
                            <div className="thday__item">
                                <div className="thday-item__wind">{wind[12]}</div>
                            </div>
                        </div>
                        <div className="current-day__separator">
                            <div className="sep-line"></div>
                        ...
                        <div className="thday-block__precip">
                            <div className="thday__item">
                                <div className="thday-item__precip">{precip[12]}</div>
                            </div>
                        </div>
                    </div>
                    <div className="current-week__item">
                        <div className="cweek-item__date">
                            <span className="cdate__day-of-week" style={daysOfWeek[13] === 'Сб' || daysOfWeek[9] === 'Вс' ? {color: '#e25555'} : {}}>{daysOfWeek[13]}</span>
                            <span className="cdate__day-of-month">{day[13]} {this.state.months[month[13]]}</span>
                        </div>
                        <div className="cweek-item__icon">
                            <img src={this.state.iconSet[this.state.iconsURL[13]]} alt=""/>
                        </div>
                        <div className="cweek-item__temp">
                            <div className="temp__day">{temp[13][1]}&#176;</div>
                            <div className="temp__night">{temp[13][0]}&#176;</div>
                        </div>
                        <div className="current-day__separator">
                            <div className="sep-line"></div>
                        </div>
                        <div className="thday-block__wind">
                            <div className="thday__item">
                                <div className="thday-item__wind">{wind[13]}</div>
                            </div>
                        </div>
                        <div className="current-day__separator">
                            <div className="sep-line"></div>
                        ...
                        <div className="thday-block__precip">
                            <div className="thday__item">
                                <div className="thday-item__precip">{precip[13]}</div>
                            </div>
                        </div>
                    </div>
                </div>
